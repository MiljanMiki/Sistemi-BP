...
{
    private Label lblJMBG, lblIme, lblPrezime, lblDatumRodjenja, lblPol, lblTelefon, lblEmail, lblAdresa, lblDatumZaposlenja, lblBrojTimova;
    private TextBox txtJMBG, txtIme, txtPrezime, txtTelefon, txtEmail, txtAdresa, txtBrojTimova;
    private DateTimePicker dtpDatumRodjenja, dtpDatumZaposlenja;
    private ComboBox cmbPol;
    private Button btnSacuvaj, btnOdustani;

    public Kordinator? Zaposlen { get; private set; }

    public DodajIzmeniKoordinatoraDialog(Kordinator? koordinator = null)
    {
        InitializeComponent();
        this.Zaposlen = koordinator ?? new Kordinator();
    ...
    private void InitializeComponent()
    {
        ...
        lblBrojTimova = new Label { Text = "Broj timova:", TextAlign = ContentAlignment.MiddleLeft };
        txtBrojTimova = new TextBox();
        ...
        tlpMain.Controls.Add(lblBrojTimova, 0, 9); tlpMain.Controls.Add(txtBrojTimova, 1, 9);
    ...
    private void PopulateFields()
    {
        ...
        txtBrojTimova.Text = Zaposlen?.BrojTimova.ToString();
    }
