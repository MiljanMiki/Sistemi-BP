...
public class DodajIzmeniVanrednuSituacijuDialog : Form
{
    ...
    public VandrednaSituacijaBasic? SituacijaBasic { get; private set; }
    private int _situacijaIdToUpdate;
    private int _idPrijava;

    public DodajIzmeniVanrednuSituacijuDialog(VandrednaSituacijaPregled? situacijaPregled = null)
    {
        InitializeComponent();
        ...
        {
            // Opciono: Mogli biste dodati logiku za odabir prijave
            // Za sada je polje za unos IdPrijave.
            _idPrijava = 0;
        }
    ...
    private void PopulateFields(VandrednaSituacijaPregled situacija)
    {
    ...
    private void BtnSacuvaj_Click(object? sender, EventArgs e)
    {
        if (ValidateInput())
        {
            SituacijaBasic = new VandrednaSituacijaBasic
            {
                ...
                Opis = txtOpis.Text,
                IdPrijava = int.Parse(txtIdPrijava.Text)
            };
