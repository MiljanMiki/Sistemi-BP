...
{
    private Label lblNaziv, lblBrojClanova, lblBaza;
    private TextBox txtNaziv, txtBaza;
    private NumericUpDown numBrojClanova;
    private Button btnSacuvaj, btnOdustani;

    public OpstaInterventnaJedBasic Jedinica { get; private set; }

    // Konstruktor za dodavanje nove jedinice
    public DodajIzmeniOpstaJedinicaDialog()
    {
        Jedinica = new OpstaInterventnaJedBasic();
        InitializeComponent();
        this.Text = "Dodaj Opštu Interventnu Jedinicu";
    }

    // Konstruktor za izmenu postojeće jedinice
    public DodajIzmeniOpstaJedinicaDialog(OpstaInterventnaJedBasic jedinica)
    {
        Jedinica = jedinica;
        InitializeComponent();
    ...
    private void InitializeComponent()
    {
        ...
        tlpMain.Controls.Add(pnlButtons, 0, 3); tlpMain.SetColumnSpan(pnlButtons, 2);
