...
public class DodajIzmeniAnaliticaraDialog : Form
{
    ...
    public AnaliticarView? Zaposlen { get; private set; }

    public DodajIzmeniAnaliticaraDialog(AnaliticarView? analiticar = null)
    {
        InitializeComponent();
        this.Zaposlen = analiticar ?? new AnaliticarView();
    ...
    { 
        if (string.IsNullOrWhiteSpace(txtJMBG.Text) || txtJMBG.Text.Length != 13 || !long.TryParse(txtJMBG.Text, out _))
        {
